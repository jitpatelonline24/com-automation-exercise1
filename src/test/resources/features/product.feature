...
#        9. Verify success message 'Thank you for your review.'
  ...
  Scenario: User should add review on product
    ...
    Then I should see text "ALL PRODUCTS" on product page
    And I click on view product of first product "Blue Top"
    And I enter "Snehal" name at your name field
    And I enter "snehalp@gmail.com" email at email address field
    And I enter "This is a good product." message to review here field
